 ...
 */
    ...
    function tablasMult(Pmultiplicando, Pmultiplicador, Plimite, PlimiteMultiplicador){
        let cantidadPar = 0;
        let cantidadImpar = 0;
        for (Pmultiplicando=1;Pmultiplicando<=Plimite;Pmultiplicando++) {
            Pmultiplicador = 0;
            for ( Pmultiplicador = 1;Pmultiplicador <= PlimiteMultiplicador; Pmultiplicador++) {
    ...
    const tablasMultExp = function(Pmultiplicando, Pmultiplicador, Plimite, PlimiteMultiplicador){
        let cantidadPar = 0;
        let cantidadImpar = 0;
        for (Pmultiplicando=1;Pmultiplicando<=Plimite;Pmultiplicando++) {
            Pmultiplicador = 0;
